    ...
    >
      ...
      >
        <input
          ...
          autoComplete="off"
          className={`
            h-[50px] rounded-[8px] px-4 text-black text-[16px] sm:text-14 w-full outline-0 font-albra_sans_l
        ...
        {label && (
          <label
            ...
            ${disabled ? "bg-none" : "bg-white"}
                    text-14 font-albra_sans_r px-1 pt-2 cursor-text`}
          >
            {label}
          </label>
        )}
        ...
        >
          ...
          <div onClick={() => type !== "multi-select" && setDisplay(false)}>
                ...
                options?.map((option) => (
                  ...
                  >
                    <div className="flex items-center">
                      <p className="text-14 font-albra_sans_l capitalize ">
                        {option?.name}
                      </p>
                    </div>
                  </div>
            ...
            >
              {type === "search" &&
                searchOptions?.map((option) => (
                  ...
                  >
                    <div className="flex items-center">
                      <p className="text-16 font-albra_sans_r">
                        {option?.name}
                      </p>
                    </div>
                  </div>
            ...
            {!loading && !options?.length && !children && (
              <p className="text-center font-albra_sans_r">No data found</p>
            )}
          </div>
        </motion.div>
      )}
